...
void main ()
{
	...
	while (!bExitFlag)
	{
		...
		else if(GetAsyncKeyState('Q') && voltVal < maxVoltage)
		{
			voltVal+= 0.01; 
			//voltageValue12 += 0.001; 
			//desired_Reading2 += 0.001;
		}
		else if(GetAsyncKeyState('A') && voltVal> minVoltage)//desired_Reading2 >= initial_load_cell_reading2 + 0.001)
		{
			voltVal -= 0.01; 
			//desired_Reading2 -= 0.001;
		}

		voltageValue4 = voltVal;
		...
		{
			cbVOut (BoardNumVoltage, 10, voltageGain, voltVal, Options);
		}
		...
		{
			cbVOut (BoardNumVoltage, 6 , voltageGain, 0, Options);
		}
		...
		{
			cbVOut (BoardNumVoltage, 2, voltageGain, 0 , Options);
		}
		...
		printf ("\nV\t%01.2f\t%01.2f\t%01.2f\t%01.2f\t%01.2f\t%01.2f", voltVal, voltageValue4, voltageValue6, voltageValue8, voltageValue10, voltageValue12);
		//printf ("\nBridge\t%01.4f\t%01.4f\t%01.2f\t%01.2f\t%01.2f\t%01.2f", load_cell_reading[1], actual_Force4,load_cell_reading[2],actual_Force8,actual_Force10);
