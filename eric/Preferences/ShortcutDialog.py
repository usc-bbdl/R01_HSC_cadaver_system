...
class ShortcutDialog(QDialog, Ui_ShortcutDialog):
    ...
    def setKeys(self, key, alternateKey,  noCheck, objectType):
        ...
        self.keyIndex = 0
        self.keys = [0, 0, 0, 0]
        self.keyEdit.setText(QString(key))
    ...
    def keyPressEvent(self, evt):
        ...
        if self.keyIndex == 1:
            self.__setKeyEditText(QString(QKeySequence(self.keys[0])))
        elif self.keyIndex == 2:
            self.__setKeyEditText(QString(QKeySequence(self.keys[0], self.keys[1])))
