    ...
    def __init__(self, parent = None, fromEric = True, displayMode = DefaultMode):
        ...
        if displayMode == ConfigurationWidget.DefaultMode:
            self.configItems = {
                ...
                "helpWebBrowserPage" : \
                    [self.trUtf8("eric4 Web Browser"), "ericWeb.png",
            ...
            raise RuntimeError("Illegal mode value: %d" % displayMode)
        ...
        self.connect(self.buttonBox, SIGNAL("rejected()"), self, SIGNAL("rejected()"))
        ...
        for index in range(parent.childCount()):
            ...
            if itm.childCount() > 0:
                ...
                visible = filter.isEmpty() or \
                          itm.text(0).contains(filter, Qt.CaseInsensitive)
            if visible:
                childVisible = True
...
class ConfigurationDialog(QDialog):
    ...
    def __init__(self, parent = None, name = None, modal = False, 
        ...
        self.connect(self.cw, SIGNAL("rejected()"), self.reject)
...
class ConfigurationWindow(KQMainWindow):
    ...
    def __init__(self, parent = None):
        ...
        self.connect(self.cw, SIGNAL("accepted()"), self.accept)
        self.connect(self.cw, SIGNAL("rejected()"), self.close)
