...
class MiniEditor(KQMainWindow):
    ...
    def __init__(self, filename = "", filetype = "", parent = None, name = None):
        ...
        self.connect(self.__textEdit, SIGNAL("linesChanged()"), self.__resizeLinenoMargin)
    ...
    def __loadFile(self, fileName, filetype = None):
        ...
        except (UnicodeDecodeError, IOError), why:
    ...
    def __saveFile(self, fileName):
        ...
        fileName = unicode(fileName)
        txt = unicode(self.__textEdit.text())
        try:
            self.encoding = Utilities.writeEncodedFile(fileName, txt, self.encoding)
        except (IOError, Utilities.CodingError, UnicodeError), why:
            KQMessageBox.warning(self, self.trUtf8("eric4 Mini Editor"),
