...
#footer a:hover {
    ...
    <script type="text/javascript">
        function update()
        {
            document.title = window.eric.translate('Welcome to eric4 Web Browser!');
            document.getElementById('headerTitle').innerHTML = window.eric.translate('eric4 Web Browser');
            ...
            document.getElementById('footer').innerHTML = window.eric.providerString()
                                                          ...
                                                          + window.eric.translate('About eric4') + '</a>';
