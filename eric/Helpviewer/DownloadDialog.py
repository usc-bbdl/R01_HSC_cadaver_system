...
class DownloadDialog(QWidget, Ui_DownloadDialog):
    ...
    def __init__(self, reply = None, requestFilename = False, webPage = None, 
        ...
        self.__windowTitleTemplate = self.trUtf8("Eric4 Download %1")
        self.setWindowTitle(self.__windowTitleTemplate.arg(""))
    ...
    def __downloadProgress(self, received, total):
        ...
        if total == -1:
            ...
            pc = "%d%%" % (received * 100 / total)
            self.setWindowTitle(self.__windowTitleTemplate.arg(pc))
    ...
    def __dataString(self, size):
        ...
        if size < 1024:
            ...
            size /= 1024.0 * 1024.0
            unit = self.trUtf8("MB")
        return QString("%1 %2").arg(size, 0, "f", 1).arg(unit)
