...
class SvnStatusDialog(QWidget, SvnDialogMixin, Ui_SvnStatusDialog):
    ...
    def start(self, fn):
        ...
        try:
            for name in fnames:
                ...
                for file in allFiles:
                    ...
                    hideSwitchedColumn = hideSwitchedColumn and not file.is_switched
        ...
        self.statusList.setColumnHidden(self.__propStatusColumn, hidePropertyStatusColumn)
        ...
        self.statusList.setColumnHidden(self.__changelistColumn, hideChangelistColumn)
