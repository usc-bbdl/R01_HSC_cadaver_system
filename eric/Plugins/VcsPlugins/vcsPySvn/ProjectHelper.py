...
class SvnProjectHelper(VcsProjectHelper):
    ...
    def initActions(self):
        ...
        self.svnChangeListsAct = E4Action(self.trUtf8('Show change lists'),
        ...
        self.connect(self.svnChangeListsAct, SIGNAL('triggered()'), self.__svnChangeLists)
        self.actions.append(self.svnChangeListsAct)
        
        self.svnRepoInfoAct = E4Action(self.trUtf8('Show repository info'), 
        ...
        self.svnRepoInfoAct.setWhatsThis(self.trUtf8(
            """<b>Show repository info</b>"""
            """<p>This shows some repository related information for"""
            """ the local project.</p>"""
        ))
        self.connect(self.svnRepoInfoAct, SIGNAL('triggered()'), self.__svnInfo)
        ...
        self.vcsResolveAct = E4Action(self.trUtf8('Conflicts resolved'),
