...
# Form implementation generated from reading ui file 'eric\Plugins\VcsPlugins\vcsSubversion\SvnLogBrowserDialog.ui'
#
...
class Ui_SvnLogBrowserDialog(object):
    def setupUi(self, SvnLogBrowserDialog):
        ...
        spacerItem = QtGui.QSpacerItem(81, 29, QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Minimum)
        self.hboxlayout1.addItem(spacerItem)
        self.vboxlayout.addLayout(self.hboxlayout1)
        self.errorGroup = QtGui.QGroupBox(SvnLogBrowserDialog)
        ...
        self.inputGroup = QtGui.QGroupBox(SvnLogBrowserDialog)
        self.inputGroup.setObjectName(_fromUtf8("inputGroup"))
        self.gridlayout = QtGui.QGridLayout(self.inputGroup)
        self.gridlayout.setObjectName(_fromUtf8("gridlayout"))
        spacerItem1 = QtGui.QSpacerItem(327, 29, QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Minimum)
        ...
        SvnLogBrowserDialog.setTabOrder(self.rxEdit, self.clearRxEditButton)
        SvnLogBrowserDialog.setTabOrder(self.clearRxEditButton, self.logTree)
        ...
        SvnLogBrowserDialog.setTabOrder(self.diffRevisionsButton, self.input)
        ...
        SvnLogBrowserDialog.setTabOrder(self.sendButton, self.buttonBox)
    ...
    def retranslateUi(self, SvnLogBrowserDialog):
        ...
        self.errorGroup.setTitle(_translate("SvnLogBrowserDialog", "Errors", None))
        self.errors.setWhatsThis(_translate("SvnLogBrowserDialog", "<b>Subversion log errors</b><p>This shows possible error messages of the svn log command.</p>", None))
        self.inputGroup.setTitle(_translate("SvnLogBrowserDialog", "Input", None))
        self.sendButton.setToolTip(_translate("SvnLogBrowserDialog", "Press to send the input to the subversion process", None))
        self.sendButton.setText(_translate("SvnLogBrowserDialog", "&Send", None))
        self.sendButton.setShortcut(_translate("SvnLogBrowserDialog", "Alt+S", None))
        self.input.setToolTip(_translate("SvnLogBrowserDialog", "Enter data to be sent to the subversion process", None))
        self.passwordCheckBox.setToolTip(_translate("SvnLogBrowserDialog", "Select to switch the input field to password mode", None))
        self.passwordCheckBox.setText(_translate("SvnLogBrowserDialog", "&Password Mode", None))
        self.passwordCheckBox.setShortcut(_translate("SvnLogBrowserDialog", "Alt+P", None))
