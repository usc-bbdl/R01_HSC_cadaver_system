...
# Form implementation generated from reading ui file 'eric\Plugins\WizardPlugins\QRegExpWizard\QRegExpWizardRepeatDialog.ui'
#
...
class Ui_QRegExpWizardRepeatDialog(object):
    def setupUi(self, QRegExpWizardRepeatDialog):
        QRegExpWizardRepeatDialog.setObjectName(_fromUtf8("QRegExpWizardRepeatDialog"))
        QRegExpWizardRepeatDialog.resize(331, 197)
        QRegExpWizardRepeatDialog.setSizeGripEnabled(True)
        self.vboxlayout = QtGui.QVBoxLayout(QRegExpWizardRepeatDialog)
        self.vboxlayout.setObjectName(_fromUtf8("vboxlayout"))
        self.groupBox = QtGui.QGroupBox(QRegExpWizardRepeatDialog)
        ...
        self.buttonBox = QtGui.QDialogButtonBox(QRegExpWizardRepeatDialog)
        ...
        QtCore.QObject.connect(self.buttonBox, QtCore.SIGNAL(_fromUtf8("accepted()")), QRegExpWizardRepeatDialog.accept)
        QtCore.QObject.connect(self.buttonBox, QtCore.SIGNAL(_fromUtf8("rejected()")), QRegExpWizardRepeatDialog.reject)
    ...
    def retranslateUi(self, QRegExpWizardRepeatDialog):
        QRegExpWizardRepeatDialog.setWindowTitle(_translate("QRegExpWizardRepeatDialog", "Number of repetitions", None))
        self.textLabel1_6.setText(_translate("QRegExpWizardRepeatDialog", "times", None))
        self.textLabel1_7.setText(_translate("QRegExpWizardRepeatDialog", "times", None))
        self.textLabel1_5.setText(_translate("QRegExpWizardRepeatDialog", "times", None))
        self.textLabel6.setText(_translate("QRegExpWizardRepeatDialog", "and", None))
        self.betweenButton.setText(_translate("QRegExpWizardRepeatDialog", "Between", None))
        self.exactButton.setText(_translate("QRegExpWizardRepeatDialog", "Exactly", None))
        self.maxButton.setText(_translate("QRegExpWizardRepeatDialog", "Maximum", None))
        self.minButton.setText(_translate("QRegExpWizardRepeatDialog", "Minimum", None))
        self.unlimitedButton.setText(_translate("QRegExpWizardRepeatDialog", "Unlimited (incl. zero times)", None))
